...
try:
    ...
    lidar_bp.set_attribute('channels', '64')  # Increased for better vertical resolution
    lidar_bp.set_attribute('points_per_second', '500000')  # Increased for better density
    lidar_bp.set_attribute('rotation_frequency', '20')  # Increased for smoother scanning
    lidar_bp.set_attribute('range', '50.0')  # Maximum range in meters
    lidar_bp.set_attribute('upper_fov', '15.0')  # Degrees for upper field of view
    lidar_bp.set_attribute('lower_fov', '-25.0')  # Degrees for lower field of view
    lidar_bp.set_attribute('noise_stddev', '0.02')  # Add slight noise for realism
